...
from models import User, UserCreate, UserOut, UserLogin, get_current_user, hash_password, verify_password, create_access_token, Token
...
async def register(user: UserCreate, session: SessionDep):
    ...
    send_email_task.delay(new_user.username)
    return new_user
